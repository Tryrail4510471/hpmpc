...
CONFIG_OPTIONS := PROTOCOL PRE PARTY BITLENGTH FRACTIONAL FUNCTION_IDENTIFIER NUM_INPUTS \
				...
				PPTI_SEQ_LEN PPTI_HIDDEN PPTI_NUM_HEADS PPTI_NUM_LAYERS PPTI_FFN_HIDDEN PPTI_TRACE \
				PPTI_MATMUL_BACKEND PPTI_LN_CENTERED_SCALE PPTI_LN_RSQRT_ITERATIONS PPTI_LN_RSQRT_INITIAL_GUESS \
				PPTI_SOFTMAX_EXP_ITERATIONS PPTI_SOFTMAX_ROWSUM_ITERATIONS \
